...
import Axios from 'axios';
    ...
    methods : {
        ...
        validarServicio(){
            ...
            if (!this.nombre) this.errorMostrarMsjServicio.push("El nombre del servicio no puede estar vacio");
            if (!this.precio) this.errorMostrarMsjServicio.push("El precio del servicio no puede estar vacio");
