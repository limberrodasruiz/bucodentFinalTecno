    ...
    <div class="container-fluid">
        ...
        <div class="card">
            <div class="card-header">
                <i class="fa fa-align-justify"></i> Tratamiento
                    ...
                    <tbody>
                        <tr v-for="tratamiento in arrayTratamiento" :key="tratamiento.id">
                            <td>
                                ...
                                <template v-if="tratamiento.condicion">
                                    <button type="button" class="btn btn-danger btn-sm" @click="desactivarTratamiento(tratamiento.id)">
                                        <i class="icon-trash"></i>
                                    </button>
                                </template>
                                <template v-else>
                                    <button type="button" class="btn btn-info btn-sm" @click="activarTratamiento(tratamiento.id)">
                                        <i class="icon-check"></i>
                                    </button>
                                </template>
                            </td>
                            <td v-text="tratamiento.nombre"></td>
                            <td v-text="tratamiento.color"></td>
                            <td v-text="tratamiento.precio"></td>
                            <td>
                                <div v-if="tratamiento.condicion">
                ...
                <div class="modal-body">
                    <form action="" method="post" enctype="multipart/form-data" class="form-horizontal">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <input type="text" v-model="color" class="form-control" placeholder="Enter color">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-md-3 form-control-label" for="email-input">Precio</label>
                            <div class="col-md-9">
                                <input type="number" v-model="precio" class="form-control" placeholder="Enter Precio">
                            </div>
                        </div>
...
import Axios from 'axios';
    ...
    methods : {
        ...
        desactivarTratamiento(id){
            swal({
                title: 'Esta seguro de desactivar este tratamiento?',
                type: 'warning',
                ...
                if (result.value) {
                    ...
                    axios.put('/tratamiento/desactivar',{
                        'id': id
                    }).then(function (response) {
                        me.listarTratamiento(1,'','nombre');
                        swal(
        ...
        activarTratamiento(id){
            swal({
                title: 'Esta seguro de activar este tratamiento?',
                type: 'warning',
                showCancelButton: true,
                confirmButtonColor: '#3085d6',
                cancelButtonColor: '#d33',
        ...
        validarTratamiento(){
            ...
            if (!this.nombre) this.errorMostrarMsjTratamiento.push("El nombre del tratamiento no puede estar vacio");
            if (!this.color) this.errorMostrarMsjTratamiento.push("El color del tratamiento no puede estar vacio");
            if (!this.precio) this.errorMostrarMsjTratamiento.push("El precio del tratamiento no puede estar vacio");
